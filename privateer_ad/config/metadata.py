...
class MetadataRegistry:
    ...
    FEATURES = {
        ...
        "bearer_0_dl_total_bytes": FeatureInfo(
            dtype="float", drop=True, is_input=False
        ),
        "bearer_0_ul_total_bytes": FeatureInfo(
            dtype="float", drop=True, is_input=False
        ),
        "bearer_1_dl_total_bytes": FeatureInfo(
            dtype="float", drop=True, is_input=False
        ),
        "bearer_1_ul_total_bytes": FeatureInfo(
            dtype="float", drop=True, is_input=False
        ),
        ...
        "bearer_0_pdu_session_id": FeatureInfo(
            dtype="string", drop=True, is_input=False
        ),
        ...
        "bearer_1_pdu_session_id": FeatureInfo(
            dtype="string", drop=True, is_input=False
        ),
        ...
        "ue_aggregate_max_bitrate_dl": FeatureInfo(
            dtype="float", drop=True, is_input=False
        ),
        "ue_aggregate_max_bitrate_ul": FeatureInfo(
            dtype="float", drop=True, is_input=False
        ),
