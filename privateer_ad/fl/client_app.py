...
class SecAggFlowerClient(NumPyClient):
    ...
    def __init__(self, context):
        ...
        self.train_pln.logger.info(f'Client - {self.partition_id} of {self.num_partitions}')
    ...
    def evaluate(self, parameters, config):
        ...
        self.train_pln.logger.info(f'Client {self.partition_id}: Evaluation completed with metrics: {metrics}')
