...
def main(grid: Grid, context: Context) -> None:
    ...
    logging.info(
        f"Federated Learning will run for {fl_config.num_rounds} rounds on {fl_config.n_clients} clients"
    )
    ...
    try:
        ...
        metrics, _ = evaluator.evaluate(
            strategy.model, test_dl, prefix="global_test", step=fl_config.num_rounds
        )
