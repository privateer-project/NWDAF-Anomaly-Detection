...
from hitl.errors import UnsupportedShape, SchemaNotFound
...
def test_schema_registry():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            print(f"✓ Correctly raised error for missing vector")
        ...
        print(f"✓ Schema ID is deterministic:")
