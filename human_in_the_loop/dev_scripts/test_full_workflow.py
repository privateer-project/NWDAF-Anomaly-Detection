...
def test_full_workflow():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        artifacts.save_threshold(version, threshold)
        ...
        for r in results[:5]:  # Show first 5
            ...
            if r['is_anomaly']:
                anomaly_count += 1
            print(f"{r['sample_id']:<8} {r['error']:<12.6f} {r['threshold']:<12.6f} {status:<10}")
        ...
        print(f"✓ Phase 5: Deployment - Model deployed to production")
        print(f"✓ Phase 6: Inference - {len(results)} new samples processed")
        print(f"✓ Phase 7: Status - System operational")
