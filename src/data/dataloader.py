...
def create_ds_loader(
    benign_data, malicious_data, window_size, step_size, features, batch_size
):
...
def create_test_ds_loaders(
    ...
    benign_test_data_loader = DataLoader(
        benign_dataset, batch_size=batch_size, shuffle=False
    )
