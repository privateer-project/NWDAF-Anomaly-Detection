...
class NWDAFDataloader:
    ...
    def create_dataset(self, df: DataFrame, use_existing_scalers: bool =True) -> TimeSeriesDataSet:
        ...
        input_features = [feature for feature in df.columns if self.features[feature].is_input]
    ...
    def get_dataset(self,
        ...
        return self.create_dataset(df, use_existing_scalers=True)
    ...
    def setup_scalers(self):
        ...
        ds = self.create_dataset(train_df, use_existing_scalers=False)
